...
<head>
    ...
    <title>CPW.LAS: Return Book</title>
    <?php
...
<body class="hold-transition sidebar-collapse scrollbarB lockscreen layout-top-nav">
  ...
  include('dist/php/sp_process_return_book.php');
  ...
  ?>
        ...
        <script>
        var element = document.getElementById("return_book");
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Return Book System</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="index.php"><i class="fas fa-folder-open"></i>
                                        Home</a></li></li>
                                <li class="breadcrumb-item active"><i class="fas fa-undo"></i> Return Book</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            ...
            <section class="content">
                <div class="container">
                    <div class="card back-box-bg border-1">
                        <div class="card-body">
                        <div id="main_wrapper" class="lockscreen-wrapper">
                            <div id="return-box" class="card card-default border-0" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">

                                <div class="">
                                    <div class="lockscreen-logo" style="margin-top: 4%">
                                        <p><b>Return System</b> ระบบคืนหนังสือ</p>
                                    </div>
                                    ...
                                    <div class="lockscreen-item">
                                        ...
                                        <div class="lockscreen-credentials">
                                            <div id="main_return_box" class="input-group">
                                                <input id="text_return_id" type="number"
                                                    class="text-white hide-arrow form-control text-placewhite text-white"
                                                    placeholder="รหัสของผู้ยืม" onkeydown="enterSubmitreturn(event)">

                                                <div class="input-group-append">
                                                    <button type="button" class="btn"><i
                                                            class="fas fa-arrow-right text-white"
                                                            onclick="returnCheck()"></i></button>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script src="dist/js/function_return_book.js"></script>
    <script>
    </script>
</body>
